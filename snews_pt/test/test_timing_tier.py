...
def test_timing_expected():
    ...
    tims = SNEWSTiersPublisher(detector_name='XENONnT', neutrino_time='2012-06-09T15:31:08.1098', timing_series=['2012-06-09T15:31:08.1098', '2012-06-09T15:33:07.8910'],
                               firedrill_mode=False)

    # Check that message has expected structure.
    assert tims.tiernames == ['CoincidenceTier', 'TimeTier']
    assert tims.message_data == {'detector_name': 'XENONnT', 'machine_time': None, 'neutrino_time': '2012-06-09T15:31:08.1098', 'p_val': None, 'p_values': None,
                                 'timing_series': ['2012-06-09T15:31:08.1098', '2012-06-09T15:33:07.8910'], 'which_tier': None, 'n_retract_latest': None,
